...
const About = () => {
  ...
  return (
      ...
      <div className="flex flex-col overflow-hidden text-white md:pt-10">
        ...
        <div className="md:h-1/2 w-full md:w-2/3 flex items-center justify-center animate__animated animate__fadeIn animate__delay-1s">
          ...
          <img
            src={myProfile}
            alt="Profile"
            className="h-24 md:h-40 md:w-40 w-24 p-2"
          />
        </div>
    ...
    A passionate Engineer, specializing in crafting digital experiences with precision and creativity. My journey began with a B.tech. I thrive on the challenge of turning ideas into beautifully designed, user-centric realities. Let's collaborate and transform your concepts into impactful digital solutions. I've delved into diverse projects that have strengthened my problem-solving skills and fostered a keen eye for detail. Beyond the code, I enjoy staying updated with the latest technologies, and contributing to the tech community. I believe in the power of innovation to shape the future and am excited about the endless possibilities that technology holds. Let's embark on a journey where creativity meets functionality, and together, we can bring your visions to life.
  </p>
          ...
          <div className='easy-in-out'>
            ...
            <div className="mt-6 flex">
              <button
                ...
                onClick={() => openLinkInNewTab('http://linkedIn.com/in/deepesh-nama-046b40170')}
              >
              ...
              <button
                ...
                onClick={() => openLinkInNewTab('https://github.com/Deepeshnama')}
              >
